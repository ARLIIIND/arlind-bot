//paramètres globaux
const yourID = "328973202887802880"; 
const setupCMD = "~messagerole"
let initialMessage = `**Réagis au messages ci-dessous pour recevoir le rôle.**`;
const roles = ["Civil"];
const reactions = ["💻"];
const botToken = "NTQzMTYwMjk1MjIxMzYyNjk4.D2Z_fg.y6z2QQfMtpLpf8zaZl3I-4o14FE"; 
const GOOGLE_API_KEY = "AIzaSyBytPKHR15g7G8ZNXZ_o1w6zs9wpjBbH50";
const prefix = '~';
